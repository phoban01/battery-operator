...
// Package v1alpha1 contains API Schema definitions for the battery v1alpha1 API group.
// +kubebuilder:object:generate=true
// +groupName=battery.liquidmetal-x.dev
package v1alpha1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "battery.liquidmetal-x.dev", Version: "v1alpha1"}
